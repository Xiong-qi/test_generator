package com.xbb.communication_gateway.kit;
...
{
	public static final String SESSION_TIME_OUT = "2";
	public static final String MSG_SESSION_TIME_OUT = "登陆超时";
	...
	public static AjaxJson sessionTimeOut() {
		AjaxJson bp = new AjaxJson();
		bp.setCode(SESSION_TIME_OUT);
		bp.setMsg(MSG_SESSION_TIME_OUT);
		return bp;
	}
