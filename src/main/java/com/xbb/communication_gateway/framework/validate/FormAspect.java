package com.xbb.communication_gateway.framework.validate;
...
import com.xbb.communication_gateway.controller.BaseController;
import com.xbb.communication_gateway.framework.SpringContext;
...
public class FormAspect {
	...
	@Around("@annotation(com.xbb.communication_gateway.framework.validate.JsonValidate)")
	@Order(1)
	...
	@Around("execution(* com.xbb.communication_gateway.controller..*.*(..))")
	@Order(2)
